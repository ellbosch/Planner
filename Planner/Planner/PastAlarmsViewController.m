...
@interface PastAlarmsViewController () {

}


@property (strong, nonatomic) NSArray *alarmArr;
...
@implementation PastAlarmsViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    Alarm *alarm = [_alarmArr objectAtIndex:indexPath.row];
